...
const namespace = process.env.NAMESPACE || "address_v1_E2D"; // address_v4_prod_adrc, address_default, addresses, name, name_address, address_v2, address_v3_adrc, address_v3_qa_adrc, address_v4_qa_adrc, address_v4_prod_adrc
