...
const vectorNamespace = process.env.NAMESPACE || "address_v8_prod_adrc"; // address_v4_prod_adrc, address_default, addresses, name, name_address, address_v2, address_v3_adrc, address_v3_qa_adrc, address_v4_qa_adrc
...
const result = await searchCustomer(initialize, 1108327, false);
console.log(result);